...
for (d = 0; d < 7; d++)
{
write("<td id=calCell "+styleTD+"cursor:hand;'  onclick='fSetSelected(this)'>");
...
with (document)
{
write("<Div id='VicPopCal' onclick='event.cancelBubble=true' style='POSITION:absolute;visibility:hidden;border:0px ridge;width:0;z-index:999;'>");
write("<table border='0' bgcolor='#c8c8c8'>");// bgcolor='#6699cc'>");
write("<TR>");
write("<td valign='middle' align='center'>");
write("<span style='cursor:hand;border:solid 0px;height:19px;font-size:12px;font-weight:bold;' onClick='fPrevMonth()'>＜</span>");
//write("<td valign='middle' align='center'><input type='button' name='PrevMonth' value='<' style='height:20;width:20;FONT:bold' onClick='fPrevMonth()'>");
write(" <Select name='tbSelYear' style='boder:solid 1px;height:19px;font-size:12px;' onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won'>");
for(i=1990;i<2051;i++)
{
write("<OPTION value='"+i+"'>"+i+"年</OPTION>");
}
write("</Select>");
write(" <select name='tbSelMonth' style='boder:solid 1px;height:19px;font-size:12px;'  onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won'>");
for (i=0; i<12; i++)
{
write("<option value='"+(i+1)+"'>"+gMonths[i]+"</option>");
}
write("</Select>");
write("<span style='cursor:hand;border:solid 0px;height:20px;font-size:12px;font-weight:bold;' onClick='fNextMonth()'>&nbsp;＞</span>");
//write(" <input type='button' name='PrevMonth' value='>' style='height:20;width:20;FONT:bold' onclick='fNextMonth()'>");
write("</td>");
write("</TR><TR>");
write("<td align='center'>");
write("<DIV style='background-color:teal'><table width='100%' border='0' cellpadding='0'>");
