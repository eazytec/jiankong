<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="device_info_query.aspx.cs" Inherits="DTcms.Web.device.device_info_query" %>
...
<body class="mainbody">
    ...
    <div class="navigation">首页 &gt; 数据审核信息</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <!--
            <a href="device_info_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加设备信息</b></span></a>
            -->
    ...
    <ItemTemplate>
      <tr>
        ...
        <td width="8%" align="center"><%#new DTcms.BLL.device_list().GetName(1)%></td>
        <td width="6%"align="center"><a href="device_shenhe.aspx?action=<%#DTEnums.ActionEnum.Edit%>&id=<%#Eval("id")%>">审核</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
