<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="device_shenhe.aspx.cs" Inherits="DTcms.Web.device.device_shenhe" %>
...
<div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; 设备信息记录 &gt; 编辑设备信息</div>
<div id="contentTab">
    <ul class="tab_nav">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>       
            <th>审核</th>
            <td><asp:DropDownList id="ddlShenHe" CssClass="select2 required" runat="server"></asp:DropDownList></td>
            </tr>         
            </tbody>
        </table>
    </div>
