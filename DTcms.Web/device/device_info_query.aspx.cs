...
{
    public partial class device_info_query : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                TreeBind(""); //绑定类别
                RptBind("id>0" +"and shenhe=1"+ CombSqlTxt(this.device_ids, this.begindate, this.enddate), "install_date desc,id desc");
            }
        }
