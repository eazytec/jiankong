<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="device_list.aspx.cs" Inherits="DTcms.Web.device.device_list" %>
...
<body class="mainbody">
    ...
    <div class="navigation">首页 &gt;设备添加 </div>
    <div class="tools_box">
	    <div class="tools_bar">
            <a href="device_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加设备</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th width="6%">选择</th>
        <th width="12%" align="left" colspan="2">通讯设备编号</th>
        <th width="12%" align="left">通讯设备名称</th>
        <th width="6%">操作</th>
      </tr>
    </HeaderTemplate>
    <ItemTemplate>
      <tr>
        ...
        <td width="12%"align="left" colspan="2"><%#Eval("device_id")%></td>
        <td width="12%" align="left"><%#Eval("device_name")%></td>
         <td width="6%"align="center"><a href="device_edit.aspx?action=<%#DTEnums.ActionEnum.Edit%>&id=<%#Eval("id")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
