<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="site_list.aspx.cs" Inherits="DTcms.Web.siteinfo.site_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 站点信息 &gt; 站点列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><%#Eval("stationId")%></td>
