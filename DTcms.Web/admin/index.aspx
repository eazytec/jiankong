            ...
            <div class="header_box">
                <div class="header_right">
                    ...
                    <br /><a href="javascript:f_addTab('home','管理中心','center.aspx')">管理中心</a> | 
                     <a target="_blank" href="../gongshi/index.aspx">公示平台</a> |  | 
        ...
        <div position="left"  title="管理菜单" id="global_left_nav"> 
            ...
            <div title="站点信息" iconcss="menu-icon-member" >
                <ul class="nlist" >
                     ...
                     <li><a href="javascript:f_addTab('zhandian','地图信息','../baseInfo/sitemap.aspx')">站点信息</a></li>
                 
                </ul>
            </div>   
            <div title="站点数据监控" iconcss="menu-icon-member" >
                <ul class="nlist" >                 
                     <li><a href="javascript:f_addTab('shishi','实时数据','../datacontrol/Currentdata.aspx')">实时数据</a></li>
                       <li><a href="javascript:f_addTab('zhandian','AQI实时报表','../datacontrol/currentAQI.aspx')">AQI实时报表</a></li>
            ...
            <div title="站点运行管理"  iconcss="menu-icon-member">
                <ul class="nlist">
                <li><a href="javascript:f_addTab('zhandianyunxing','站点运行信息','../datacontrol/Currentdata.aspx')">站点运行信息</a></li>   
                </ul>           
            </div>

            <div title="报警管理" iconcss="menu-icon-member">
            <ul class="nlist">
            <li><a href="javascript:f_addTab('baojing','报警信息','../baojing/baojing_list.aspx')">报警信息</li>
            </ul>         
            </div>
